...
export const IMAGE_REQUIREMENTS = Object.freeze({
  ...
  specialityTopBanner: {
    ...
    minHeight: 600,
    fit: "cover",
    note: "Displayed as a 450 px-high desktop hero and a 400-420 px-high mobile hero. Mobile screens crop the sides, so keep the subject and important content centred.",
  },
  specialityMain: {
    ratioLabel: "3:2",
    ratioWidth: 3,
    ...
    minHeight: 1000,
    fit: "cover",
    note: "Matches the responsive department image shown below the description. Keep the main subject centred because edges may crop slightly between mobile, tablet, and desktop.",
  },
  specialityBrochure: {
