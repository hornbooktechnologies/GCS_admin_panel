  ...
  return (
    <div className="max-w-[1600px] space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">College Results</h1>
        ...
        <div className="flex gap-3">
          ...
          {canCreate && (
            ...
            <Button type="button" className="rounded-lg" onClick={() => navigate("/results/new")}>
                  ...
                  <tr key={item.id}>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex justify-end gap-2">
                        <Button type="button" variant="outline" className="rounded-lg" onClick={() => navigate(`/results/${item.id}/edit`)}>
